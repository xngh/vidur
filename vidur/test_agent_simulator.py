...
class TestAgentSimulator:
    ...
    def _init_app_queue(self, reqs: List[UnifiedRequest]) -> None:

        for unified_request in reqs:
            heapq.heappush(self._app_queue, (unified_request.arrive_at, unified_request))
